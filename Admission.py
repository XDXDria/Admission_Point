...
def get():
    ...
    if pass_faculty == 2024:
        if ans >= 19055.35:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2025:
        if ans >= 17602.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2026:
        if ans >= 15965.9:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2027:
        if ans >= 17904.45:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2028:
        if ans >= 18131.4:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2029:
        if ans >= 17647.15:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2030:
        if ans >= 15795.3:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2031:
        if ans >= 16556.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2032:
        if ans >= 18002.05:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2033:
        if ans >= 17737.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2034:
        if ans >= 16298.65:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2035:
        if ans >= 16861.95:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2036:
        if ans >= 17148.75:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2037:
        if ans >= 16302.95:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2038:
        if ans >= 17170.7:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2039:
        if ans >= 16646.25:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2040:
        if ans >= 18353.75:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2041:
        if ans >= 17175.7:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2042:
        if ans >= 17499.55:
            print "PASS"
        else:
            print "NOT PASS"
        ...
        if ans >= 14999.45:
            ...
            print "NOT PASS"
    elif pass_faculty == 2046:
        if ans >= 15811.25:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2047:
        if ans >= 16136.3:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2048:
        if ans >= 15420:
            print "PASS"
        else:
            print "NOT PASS"
        ...
        if ans >= 13261:
            ...
            print "NOT PASS"
    elif pass_faculty == 2050:
        if ans >= 8968.25:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2051:
        if ans >= 12505.35:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2052:
        if ans >= 11939.35:
            print "PASS"
        else:
        ...
        if ans >= 11702.6:
            ...
            print "NOT PASS"
    elif pass_faculty == 2054:
        if ans >= 12400:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2055:
        if ans >= 13133.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2056:
        if ans >= 13839.35:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2057:
        if ans >= 14271.3:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2058:
        if ans >= 14277.55:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2059:
        if ans >= 13933.8:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2060:
        if ans >= 11243.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2061:
        if ans >= 13724.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2062:
        if ans >= 13213.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2063:
        if ans >= 12953.25:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2064:
        if ans >= 14944.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2065:
        if ans >= 13168.8:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2066:
        if ans >= 13852.55:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2067:
        if ans >= 14337.55:
            print "PASS"
        else:
            print "NOT PASS"
        ...
        if ans >= 17757.85:
            ...
            print "NOT PASS"
    elif pass_faculty == 2069:
        if ans >= 15257.5:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2070:
        if ans >= 15497.45:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2071:
        if ans >= 15943.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2072:
        if ans >= 10783.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2073:
        if ans >= 11013.2:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2074:
        if ans >= 9789.4:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2075:
        if ans >= 11161.25:
            print "PASS"
        else:
            print "NOT PASS"
    elif pass_faculty == 2076:
        if ans >= 10295.7:
            print "PASS"
        else:
            print "NOT PASS"
