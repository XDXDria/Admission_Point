...
e0 = Entry(master).grid(row=0, column=1)
e1 = Entry(master).grid(row=1, column=1)
e2 = Entry(master).grid(row=2, column=1)
e3 = Entry(master).grid(row=3, column=1)
e4 = Entry(master).grid(row=4, column=1)
e5 = Entry(master).grid(row=5, column=1)
e6 = Entry(master).grid(row=6, column=1)
e7 = Entry(master).grid(row=7, column=1)
e8 = Entry(master).grid(row=8, column=1)
e9 = Entry(master).grid(row=0, column=3)
e10 = Entry(master).grid(row=1, column=3)
e11 = Entry(master).grid(row=2, column=3)
e12 = Entry(master).grid(row=3, column=3)
e13 = Entry(master).grid(row=4, column=3)
e14 = Entry(master).grid(row=5, column=3)
e15 = Entry(master).grid(row=6, column=3)
e16 = Entry(master).grid(row=7, column=3)
e17 = Entry(master).grid(row=8, column=3)
